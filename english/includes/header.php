      ...
      <ul class="nav navbar-nav navbar-right">        
        ...
        <li class="dropdown" id="navOrder">
          ...
          <ul class="dropdown-menu">            
            <li id="topNavAddOrder"><a href="orders.php?o=add"> <i class="glyphicon glyphicon-plus"></i> Add product</a></li>            
            <li id="topNavManageOrder"><a href="orders.php?o=manord"> <i class="glyphicon glyphicon-edit"></i> Manage product</a></li>            
          </ul>
        </li> 
        ...
        <li class="dropdown" id="navSetting">
          ...
          <ul class="dropdown-menu">            
            ...
            <li id="topNavLogout"><a href="logout.php"> <i class="glyphicon glyphicon-log-out"></i> Signout</a></li>            
          </ul>
        </li>        
             <li class="dropdown" id="navSetting">
          ...
          <ul class="dropdown-menu">            
            <li id="topNavSetting"><a href="https://highstorestock.tyinf.com/dashboard.php"> <i class="glyphicon glyphicon"></i> عربي</a></li>            
