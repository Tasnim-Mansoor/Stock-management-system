...
<!DOCTYPE html>
	...
	<title>Highstore Stock Management System</title>
...
<body>
    ...
    <div class="navbar-header">
      ...
      <!-- <a class="navbar-brand" href="#">الماركة</a> -->
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
      ...
      <ul class="nav navbar-nav navbar-right">        
        ...
        <li id="navBrand"><a href="brand.php"><i class="glyphicon glyphicon-btc"></i>  الماركة</a></li>        

        <li id="navCategories"><a href="categories.php"> <i class="glyphicon glyphicon-th-list"></i> الفئات</a></li>        
        ...
        <li class="dropdown" id="navOrder">
          ...
          <ul class="dropdown-menu">            
            <li id="topNavAddOrder"><a href="orders.php?o=add"> <i class="glyphicon glyphicon-plus"></i> اضف الطلب</a></li>            
            <li id="topNavManageOrder"><a href="orders.php?o=manord"> <i class="glyphicon glyphicon-edit"></i> ادارة الطلبات</a></li>            
          </ul>
        </li> 
        ...
        <li class="dropdown" id="navSetting">
          ...
          <ul class="dropdown-menu">            
            <li id="topNavSetting"><a href="setting.php"> <i class="glyphicon glyphicon"></i> عربي</a></li>            
            <li id="topNavLogout"><a href="https://highstorestock.tyinf.com/english/dashboard.php"> <i class="glyphicon glyphicon"></i> انجليزي</a></li>            
          </ul>
        </li>        
      </ul>
    </div><!-- /.navbar-collapse -->
